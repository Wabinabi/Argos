...
The electronics package contains an accelerometer and compass, in addition to the ones mounted on the flight controller. These operate independently of the flight system and are not required for flight. They are, however, used for data collection and position estimation for the 3D map.\hypertarget{md__h__repos__argous_src_esp32_as7_gamma__on__board__software_autotoc_md30}{}\doxysubsection{Data Gathering and Hardware Features}\label{md__h__repos__argous_src_esp32_as7_gamma__on__board__software_autotoc_md30}
The \mbox{\hyperlink{namespace_a_s7}{AS7}} drone houses an electronics package for collecting mapping data of the environment. Sensors on-\/board collect and store the data onto the Micro\+SD card located the rear of the drone.\hypertarget{md__h__repos__argous_src_esp32_as7_gamma__on__board__software_autotoc_md31}{}\doxysubsubsection{Setting up the Micro\+SD Card}\label{md__h__repos__argous_src_esp32_as7_gamma__on__board__software_autotoc_md31}
...
\end{DoxyItemize}\hypertarget{md__h__repos__argous_src_esp32_as7_gamma__on__board__software_autotoc_md33}{}\doxysubsection{Arming and Flight Setup}\label{md__h__repos__argous_src_esp32_as7_gamma__on__board__software_autotoc_md33}
