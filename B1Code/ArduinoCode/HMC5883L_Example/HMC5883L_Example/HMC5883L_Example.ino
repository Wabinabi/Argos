...
void compassCalibrate(void)
{
  ...
  while (xcount < 3 || ycount < 3 || zcount < 3) {
    ...
    if (valueMin.ZAxis > value.ZAxis) {
      ...
      Serial.println("TEST CALIBRATE5");
    if (xZero) {
    ...
    Serial.println("TEST CALIBRATE6");
